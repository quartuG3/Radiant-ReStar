...
humanoid-profile-editor-open-image-button = Открыть изображение
...
humanoid-profile-editor-preference-unavailable-spawn-as-overflow-button = Начните с доступной работы, если предпочтение недоступно.
