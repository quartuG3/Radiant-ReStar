...
ent-VendingMachineNfsdDrobe = ДШдроб
    .desc = Элитная экипировка для сотрудников ДШ! Будьте в авангарде моды и безопасности с лучшей формой и снаряжением для защитников порядка.
...
ent-VendingMachineNfsdTech = ДШФтех
