...
ent-ComputerShipyardSecurity = консоль приёма в ДШ
...
ent-ComputerShipyardNfsd = консоль верфи ДШ
    .desc = Здесь вы можете приобрести патрульные шаттлы ДШ, оснащенные новейшими технологиями и готовые к самым сложным заданиям. Поддержите закон и порядок среди звезд, используя надежные и мощные шаттлы, созданные для настоящих героев.
...
ent-ComputerShipyardSr = консоль верфи персонала фронтира
